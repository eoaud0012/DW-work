...
# === API 키 및 민감 정보 직접 설정 (테스트용) ===
# 아래 값을 실제 환경에 맞게 수정하세요.
# (Azure OpenAI 엔드포인트 관련 정보)
azure_endpoint = "https://apim-dwdp-openai.azure-api.net/007/deployments/gpt-4o/chat/completions?api-version=2024-04-01-preview"
azure_subscription_key = "d932deacbffc451e84417fac864394b9"
azure_application = "nikkei_nes_scrapping_test"
azure_compCode = "동원산업"
azure_userID = "eoaud0012"
azure_userNM = "이대명"
azure_serviceType = "번역"  # 예: 번역 서비스인 경우

# 이메일 관련 정보
email_password = "ywad kvgh etlc nafm"  # 앱 전용 비밀번호(2FA 사용 시) 권장
sender_email = "eoaud0012@gmail.com"

# (옵션) 환경 변수에 설정 (추후 os.getenv로 읽어올 수 있음)
    ...
    try:
        ...
        for tag in article_link_tags:
            ...
            try:
                ...
                content_div = article_soup.find("div", class_=re.compile(r"(article|content)"))
                content = content_div.get_text(separator="\n", strip=True) if content_div else "내용 없음"
