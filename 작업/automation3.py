...
options = Options
sservice = Service(executable_path=r'C:\Users\DW-PC\.vscode\작업\chromedriver.exe')
options = Options()
options.add_experimental_option("detach", True)
driver = webdriver.Chrome(service=sservice, options=options) # Webdriver 파일의 경로를 입력
...
Select(driver.find_element(By.ID, "resveEndTm")).select_by_visible_text("10:00")
time.sleep(0.5)
